...
export const listBithday = /* GraphQL */ `
	query ListBirthday($filter: ModelBirthdayFilterInput, $limit: Int, $nextToken: String) {
...
export const listEvents = /* GraphQL */ `
	query ListEvents($id: ID, $filter: ModelEventFilterInput, $limit: Int, $nextToken: String, $sortDirection: ModelSortDirection) {
...
export const listNewArrivals = /* GraphQL */ `
	query ListNewArrivals(
		...
		listNewArrivals(id: $id, filter: $filter, limit: $limit, nextToken: $nextToken, sortDirection: $sortDirection) {
			items {
				date
				users {
					items {
...
export const listNewArrivalsLight = /* GraphQL */ `
	query ListNewArrivals(
		$id: ID
		$filter: ModelNewArrivalsFilterInput
		$limit: Int
...
export type ListNewArrivalsLightQuery = {
	listNewArrivals?: {
		__typename: 'ModelNewArrivalsConnection';
		items: Array<{
			__typename: 'NewArrivals';
...
export const subscriptionToEvent = /* GraphQL */ `
	query SubscriptionToEvent($filter: ModelUsersEventsFilterInput, $limit: Int, $nextToken: String) {
